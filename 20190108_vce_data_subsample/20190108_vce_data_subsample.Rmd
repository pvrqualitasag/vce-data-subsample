...
```{r}
mean(unlist(l_rep_results["id",]))
sd(unlist(l_rep_results["id",]))
mean(unlist(l_rep_results["herd",]))
sd(unlist(l_rep_results["herd",]))
mean(unlist(l_rep_results["residual",]))
sd(unlist(l_rep_results["residual",]))
```
